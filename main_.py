...
class FrameApp(Frame):
    def __init__(self, master):
        ...
        self.b1 = Button(self, text="PLAY SONG",font= ('Times New Roman',14), command=self.play_music, bg='#42b3d3', width=40)
        self.b1.grid(row=2, column=0)

        self.b2 = Button(self, text="PREVIOUS SONG", font=('Times New Roman', 14), command=self.previous_song, bg='#42b3d3', width=40)
        self.b2.grid(row=4, column=0)

        self.b3 = Button(self, text="PAUSE/UNPAUSE", font=('Times New Roman',14), command=self.toggle, bg='#42b3d3', width=40)
        self.b3.grid(row=3, column=0)

        self.b4 = Button(self, text="NEXT SONG", font=('Times New Roman', 14), command=self.next_song, bg='#42b3d3', width=40)
        self.b4.grid(row=5, column=0)

        self.b5 = Button(self, text="ADD TO PLAYLIST", font=('Times New Roman', 14), command=self.add_to_list, bg='#42b3d3', width=40)
        self.b5.grid(row=1, column=0)

        self.label1 = Label(self, fg='Black', font=('Poppins 12 bold italic', 10), bg='#6cc3df')
        self.label1.grid(row=6, column=0)

        self.output = Text(self, wrap=WORD, width=100)
...
window.title(" ✌️ MP3 Music Player 🤡 ")
